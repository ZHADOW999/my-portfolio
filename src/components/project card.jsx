...
const ProjectCard = ({project}) => {
    return ( 
        <div className='flex flex-col md:flex-row md:items-center md:justify-center  gap-10 mt-20 '> 
            ...
            <p className="absolute top-3 text-1 sm:text-2 left-1 sm:h-8 grid place-items-center rounded-[30px] text-white sm:w-24 h-6 !w-auto px-3 bg-dark-bg">{project.type}</p>
